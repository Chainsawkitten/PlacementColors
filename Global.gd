...
var textures = [preload("res://Graphics/Pieces/Pawn.png"),
				...
				preload("res://Graphics/Pieces/PawnW.png"),
				preload("res://Graphics/Pieces/BishopW.png"),
				preload("res://Graphics/Pieces/RookW.png"),
				preload("res://Graphics/Pieces/KnightW.png"),
				preload("res://Graphics/Pieces/KingW.png"),
				preload("res://Graphics/Pieces/QueenW.png")]
...
# Piece textures.
var textures_bg = [preload("res://Graphics/Pieces/PawnBG.png"),
				   preload("res://Graphics/Pieces/BishopBG.png"),
				   preload("res://Graphics/Pieces/RookBG.png"),
				   preload("res://Graphics/Pieces/KnightBG.png"),
				   preload("res://Graphics/Pieces/KingBG.png"),
				   preload("res://Graphics/Pieces/QueenBG.png")]
...
func get_piece_texture(type, color):
	return textures[type - 1 + color * 8]
...
# Get the bg texture for a chess piece.
#  type - the type of chess piece
func get_piece_bg_texture(type):
	return textures_bg[type - 1]
